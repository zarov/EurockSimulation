...
public class AgentBody extends AbstractMobileObject implements Body {
	 ...
	 */
	public AgentBody(AgentAddress owner, double size, double maxLinearSpeed,
			double maxLinearAcceleration, double maxAngularSpeed,
			double maxAngularAcceleration, long perceptionRange) {
		super(size, maxLinearSpeed, maxLinearAcceleration, maxAngularSpeed,

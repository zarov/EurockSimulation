...
public abstract class Animat<ABT extends AgentBody> extends Agent {
	 ...
	 */
	protected final void influenceKinematic(Vector2d linearInfluence, double angularInfluence) {
	 ...
	 * @param angularInfluence is the angular influence to apply on the object.
	 */
	protected final void influenceSteering(Vector2d linearInfluence, double angularInfluence) {
